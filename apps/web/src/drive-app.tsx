...
function LandingPage() {
  ...
  return <main className="flex min-h-screen flex-col overflow-hidden bg-[#f7fafc] text-slate-900">
    ...
    <section className="mx-auto grid max-w-7xl gap-8 px-5 py-16 sm:px-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center"><div><p className="text-sm font-bold uppercase tracking-[0.15em] text-blue-600">One Drive. Two ways to work.</p><h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl">Manage visually. Automate precisely.</h2><p className="mt-4 max-w-xl text-base leading-7 text-slate-600">Both interfaces use the same private Drive. Choose the GUI for interactive product work, or the CLI when a task belongs in a terminal, script or job.</p><div className="mt-7 grid gap-3 sm:grid-cols-2"><article className="rounded-2xl border border-blue-100 bg-white p-4 shadow-sm"><span className="grid size-9 place-items-center rounded-xl bg-blue-50 text-blue-700"><MonitorUp size={18} /></span><p className="mt-4 text-xs font-bold uppercase tracking-[0.14em] text-blue-700">GUI</p><h3 className="mt-1 text-base font-semibold text-slate-950">Everyday control</h3><p className="mt-2 text-xs leading-5 text-slate-600">Browse, upload, share and manage all six products visually, including browser-only ZominAI.</p><a className="mt-4 inline-flex items-center gap-1.5 text-xs font-bold text-blue-700 hover:text-blue-900" href={docsUrl()}>Explore GUI <ArrowUpRight size={14} /></a></article><article className="rounded-2xl bg-slate-950 p-4 text-white shadow-sm"><span className="grid size-9 place-items-center rounded-xl bg-white/10 text-cyan-300"><Terminal size={18} /></span><p className="mt-4 text-xs font-bold uppercase tracking-[0.14em] text-cyan-300">CLI</p><h3 className="mt-1 text-base font-semibold">Repeatable operations</h3><p className="mt-2 text-xs leading-5 text-slate-300">Script file work, checks and automation across Drive, Paste, Transfer, Shared Drives, Databases and Functions.</p><a className="mt-4 inline-flex items-center gap-1.5 text-xs font-bold text-cyan-300 hover:text-white" href={docsUrl("cli")}>Explore CLI <ArrowUpRight size={14} /></a></article></div></div><div className="grid gap-3 rounded-2xl bg-slate-950 p-4 shadow-xl shadow-slate-900/15 sm:p-5"><article className="rounded-xl border border-slate-200 bg-white p-4"><div className="flex items-center justify-between text-xs font-semibold text-slate-500"><span className="flex items-center gap-2"><MonitorUp size={15} className="text-blue-600" /> GUI workspace</span><span className="rounded-full bg-blue-50 px-2 py-1 text-[10px] font-bold text-blue-700">interactive</span></div><div className="mt-4 flex items-center justify-between rounded-lg border border-slate-100 bg-slate-50 p-3"><span className="flex items-center gap-2 text-sm font-semibold text-slate-800"><Folder size={16} className="text-blue-600" /> Product/Launch</span><button className="rounded-md bg-blue-600 px-2.5 py-1.5 text-xs font-semibold text-white" type="button">Share</button></div><div className="mt-3 grid grid-cols-3 gap-2 text-[10px] font-medium text-slate-500"><span className="rounded-md bg-slate-100 px-2 py-1.5">Upload</span><span className="rounded-md bg-slate-100 px-2 py-1.5">Organise</span><span className="rounded-md bg-slate-100 px-2 py-1.5">Control access</span></div></article><article className="rounded-xl border border-white/10 bg-[#070b1d] p-4"><div className="flex items-center gap-2 text-xs font-semibold text-slate-400"><Terminal size={16} /> CLI workspace <span className="ml-auto rounded-full bg-cyan-300/10 px-2 py-1 text-[10px] font-bold text-cyan-300">scriptable</span></div><pre className="mt-4 overflow-x-auto text-xs leading-6 text-slate-200"><code><span className="text-slate-500">$ </span><span className="text-cyan-300">zo-drive</span> upload ./launch-plan.pdf <span className="text-amber-300">--path</span> Product/Launch{`\n`}<span className="text-emerald-300">✓</span> Uploaded Product/Launch/launch-plan.pdf</code></pre></article></div></section>
