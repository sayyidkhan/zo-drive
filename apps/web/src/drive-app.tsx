...
function DocsPage({ mode }: { mode: "gui" | "cli" }) {
  ...
  const sections = isGui
    ...
    : [
        ...
        { id: "connection", eyebrow: "Local-to-cloud connection", icon: <Cloud size={20} />, title: "Connect your local computer to Zo", body: "zo-drive connects from your local terminal to this Zo Computer over its public HTTPS /drive address. You do not need SSH, Tailscale, or a Zo dashboard session on the local machine.", steps: ["Copy the public Zo Drive address shown below into ZO_DRIVE_API_URL.", "Run zo-drive login with the Zo Drive owner username and password.", "Copy the printed ZO_DRIVE_SESSION_TOKEN export into the same terminal session. Keep it private."] },
