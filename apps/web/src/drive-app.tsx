...
import { LandingRemix } from "./landing-remix.js";
...
const GUI_CHANGELOG = [
  {
    version: "v1.26.0",
    date: "2026-07-25",
    changes: ["Rebuilt the public Zo Drive landing experience around the ownership story, six-product suite, private-workspace preview, and a responsive interactive particle field."]
  },
  {
    version: "v1.25.0",
    date: "2026-07-22",
...
function LandingPage() {
  return <LandingRemix
    cloudLogoUrl={driveCloudLogoUrl}
    docsUrl={docsUrl()}
    driveUrl={driveAppUrl()}
    loginUrl={loginUrl()}
    pegasusLogoUrl={drivePegasusLogoUrl}
  />;
}
...
function ZominAiWorkspace({ initialPane = "verify" }: { initialPane?: ZominAiPane }) {
  ...
  const panes: Array<{ description: string; icon: React.ReactNode; id: ZominAiPane; label: string }> = [
    { id: "verify", label: "Verify service", description: "Check the Zo Computer gateway", icon: <ShieldCheck size={18} /> },
    { id: "install", label: "Zo Computer setup", description: "Set up the shared Bonsai service", icon: <Download size={18} /> },
    { id: "settings", label: "Service settings", description: "Shared model and context preferences", icon: <Settings2 size={18} /> },
