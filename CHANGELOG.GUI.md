...
- Expanded the Zo Shared Drives sharing workspace to the full available width.
...
- Refined the Zo Drive product-family heading on the main landing page.

## v1.42.21 - 2026-07-24

### Added

- Added a GitHub source-code action to the main landing hero.
...
- Restored visible custom tooltips for the collapsed desktop sidebar.
...
- Moved the ownership advantage panel directly below the landing-page hero.
